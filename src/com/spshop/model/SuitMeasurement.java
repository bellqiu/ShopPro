...
public class SuitMeasurement {
	...
	public SuitMeasurement(float height, float weight, float age,
			...
			float shirtNeck, float jacketShirtLenght, float chestSize,
			float stomachSize, float jacketHips, float shoulderSize,
			float sleeveLength, float bicepSize, float wristSize,
			float pantsLength, float waist, float crotch, float thighSize,
			float kneeSize) {
		super();
		this.height = height;
		this.weight = weight;
