...
public class GenerateClass {
	...
	public static void main(String[] args) {
		System.out.println(GenerateClass.generateTestCase());
	}
		...
		try {
			for (int i = 0; i < list.size(); i++) {
				if (list.get(i).toString().indexOf("Type") != -1
					...
					String serviceName = str.replace(str.charAt(0), (char)(str.charAt(0)+32));
					builder.append("\t\t"+str+"Service "+serviceName+"Service = ServiceFactory.getService("+str+"Service.class);\n");
					builder.append("\t\t"+str+" "+serviceName+" = new "+str+"();\n");
					builder.append("\t\t"+serviceName+"Service.save("+serviceName+");\n");
				}
			}
		} catch (Exception e) {
	...
	public static void generateClasses() {
		...
		try {
			for (int i = 0; i < list.size(); i++) {
				String str = "C:\\guan\\test\\" + list.get(i)
						+ "ServiceImpl.java";
				GenerateClass.creatTxtFile(str);
				builder.append("package com.spshop.service.impl;\n\n");
				builder.append("import com.spshop.dao.intf." + list.get(i)
						+ "DAO;\n\n");
				builder.append("import com.spshop.model." + list.get(i)
						+ ";\n\n");
				builder.append("import com.spshop.service.AbstractService;\n\n");
				builder.append("import com.spshop.service.intf." + list.get(i)
						+ "Service;\n\n");
				builder.append("public class " + list.get(i)
						+ "ServiceImpl extends AbstractService<" + list.get(i)
						+ "," + list.get(i) + "DAO, Long> implements "
						+ list.get(i) + "Service{\n\n");
				builder.append("}");
