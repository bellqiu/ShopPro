    ...
    <td colspan="3">
      <table width="700" cellspacing="0" cellpadding="0" border="0" align="center">
        ...
        <tr>
          ...
          <td> <img board="0" title="honeybuy.com" alt="honeybuy.com" src="https://www.honeybuy.com/image/4614200824386.jpg"> </td>
          <td align="right" style="FONT-SIZE: 14pt">Shipment 
        Notification</td> </tr> </tbody> </table>
      <table width="700" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" align="center" style="BORDER-BOTTOM: #c9c9ca 1px solid; BORDER-LEFT: #c9c9ca 1px solid; BORDER-TOP: #d4232b 1px solid; BORDER-RIGHT: #c9c9ca 1px solid">
        <tbody>
        <tr>
          <td colspan="2">
            <table width="700" height="55" cellspacing="0" cellpadding="0" border="0" align="center" style="BORDER-BOTTOM: #c9c9ca 1px solid; FONT-SIZE: 12px">
              <tbody>
              <tr>
                <td width="22"> </td>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="FONT-SIZE: 12px">
              ...
              <tr>
                <td width="100%" height="26" bgcolor="#0000FF" colspan="6">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" style="COLOR: #ffffff; FONT-SIZE: 12px">
                    <tbody>
                    <tr align="left">
                      <td width="22"> </td>
              ...
              <tr>
                <td width="100%" height="26" colspan="6" style="BORDER-BOTTOM: rgb(221,221,221) 1px dashed; LINE-HEIGHT: 18px">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" style="FONT-SIZE: 12px">
                    ...
                    <tr align="left">
                      <td width="22"> </td>
                      <td width="594"> <a href="http://www.honeybuy.com/${item.product.name}" style="color:#1E4E8E;text-decoration:none;text-underline:none">${item.product.title}</a></td>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="BORDER-BOTTOM: #c9c9ca 1px solid; FONT-SIZE: 12px; BORDER-TOP: #c9c9ca 1px solid">
              <tbody>
              <tr>
                <td height="10"> </td> </tr>
              <tr valign="top">
                <td style="PADDING-BOTTOM: 0px; PADDING-LEFT: 22px; PADDING-RIGHT: 22px; PADDING-TOP: 0px"> <strong>Please 
            ...
            <table width="700" cellspacing="0" cellpadding="0" border="0" align="center" style="COLOR: #6f7074; FONT-SIZE: 12px">
              <tbody>
              <tr>
                <td height="15"> </td> </tr>
              <tr>
                <td> </td>
                <td colspan="2" style="COLOR: #444; FONT-SIZE: 13px"> <strong>Frequently Asked Questions</strong> </td> </tr>
              <tr>
                <td height="10"> </td> </tr>
              <tr valign="top">
                <td width="22"> </td>
                <td width="44%" style="TEXT-ALIGN: left">
                  <p style="LINE-HEIGHT: 14px; MARGIN: 10px 0px"> <strong style="COLOR: #444">How do I track my package?</strong> </p>
                  <p style="LINE-HEIGHT: 14px; MARGIN: 10px 0px">All available 
                  tracking information has been provided above and in your <a href="http://www.honeybuy.com/uc/orderDetails?id=${order.name}" style="COLOR: #1e4e8e; TEXT-DECORATION: none" target="_blank">My Order</a>. Some carriers may not provide tracking 
                  ...
                  regarding processing and delivery times, please see <a href="http://www.honeybuy.com/c/Shipping-Information" style="COLOR: #1e4e8e; TEXT-DECORATION: none" target="_blank">Shipping Information</a>.</p>
                  ...
                  receiving your package. For more information, visit our <a href="http://www.honeybuy.com/c/Return-Exchange" style="COLOR: #1e4e8e; TEXT-DECORATION: none" target="_blank">Return Exchange</a> policy.</p>
                  <p style="LINE-HEIGHT: 14px; MARGIN: 10px 0px">For all other 
                  questions, visit our <a href="http://www.honeybuy.com/c/FAQ" style="COLOR: #1e4e8e; TEXT-DECORATION: none" target="_blank">FAQ</a>.</p>
                ...
                <td width="37"> </td>
                <td width="44%" style="TEXT-ALIGN: left">
                  <p style="LINE-HEIGHT: 14px; MARGIN: 10px 0px"> <strong style="COLOR: #444">What if my package was damaged during 
                  delivery?</strong> </p>
                  ...
                  any order, just log in to <a href="http://www.honeybuy.com/uc/orderDetails?id=${order.name}" style="COLOR: #1e4e8e; TEXT-DECORATION: none" target="_blank">My Order</a> and click on the order you need help with.Through the 
                  ...
                  any order information. <br>For all other questions, please send Email to: <em>service@honeybuy.com</em>.</p> </td>
                <td width="22"> </td> </tr>
              <tr>
                <td height="22"></td> 
            ...
            <table width="700" cellspacing="0" cellpadding="0" border="0" align="center" style="FONT-SIZE: 12px; BORDER-TOP: #c9c9ca 1px solid">
              <tbody>
              <tr>
                <td height="10" colspan="2"> </td> </tr>
              <tr>
                <td align="center" colspan="2"> <a href="http://www.honeybuy.com" target="_blank"> <img border="0" src="http://cloud.lbox.me/images/wholesale/201009/ipad/en.jpg"> </a> 
                </td> </tr>
              <tr>
      ...
      <table width="700" cellspacing="0" cellpadding="0" border="0" align="center">
        ...
        <tr valign="top">
          ...
          <td height="50" style="COLOR: #646464; FONT-SIZE: 12px"> <strong>PLEASE 
            ...
            email. If you have any questions, please send Email to: <em>service@honeybuy.com</em>. Thank you for your cooperation!</td>
          <td width="22"> </td> </tr>
        <tr>
          <td width="22"> </td>
          <td height="20" align="center" style="COLOR: #646464; FONT-SIZE: 12px">Copyright&copy; 2012 HoneyBuy.com; Inc. All Rights Reserved. | <a href="http://www.honeybuy.com/c/Terms-Of-Use">Terms of Use </a>| <a href="http://www.honeybuy.com/c/Privacy-Policy">Privacy Policy </td>
          <td width="22"> </td> </tr>
        <tr>
