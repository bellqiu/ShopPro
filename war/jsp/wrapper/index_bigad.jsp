...
<c:if test='${isHome == "true"}'>
		...
		<div class="measure_dashboard_content">
			...
			<div class="measure_panel">
				<a href="http://www.honeybuy.com/c/Fashion-Apparel"><img alt="Fashion Apparel" title="Fashion Apparel"  width="972px" height="428px" src="/image/Banner20120515-3.png"></a>
			</div>
			<div class="measure_panel">
