...
mainmenu();
	...
	<script type="text/javascript">var Image_url = 'https://www.mlo.me/image/endefault/';</script>
	<script language="javascript"
		src="https://www.mlo.me/javascript/common.js"></script>
	<script language="javascript">var lastUserName='';
var lastpassword='';
var lastemail='';
var lastcode='';
	...
	<body>
		<div class="main_box main122">
				...
				<div class="item_blue1">
					...
					<form action="login.do" method="post">
						<ul class="table_ul1 loginReg">
							<li>Your E-mail address:<br> <input
									name="loginEmail" id="loginEmail" type="text" size="35"
									maxlength="50" />
									<div class="message_yes"></div>
							</li>
							<li>Password:<br> <input name="loginPassword"
									type="password" id="loginPassword" size="35" maxlength="20" />
							</li>
							<li><A
								href="recoveryPassword.jsp">Forgot
									your password? Click here</A>
							</li>
			...
			<div class="form_blue2">
				<div class="item_blue2">
					...
					<div class="loginReg_font">
						...
						respect and protect your personal information.<br />$10 bonus
						code will be instantly sent to your inbox once you sign up,<br />Enter
					...
					<form action="createAccount.do" method="post"
						...
						<input name="forward" type="hidden"
							value="http://www.milanoo.com/" />
						<ul class="table_ul1 loginReg">
							<li><i>E-mail address:</i><font>*</font> <input name="email"
								id="email" size="32" maxlength="100" onBlur="checkemail();" />
							</li>
							<li id="validateEmail" style="display: none"
								class="message_error"></li>
							<li><i>Create a password:</i><font>*</font> <input
								name="password" id="password" type="password"
								onBlur="checkpassword();" size="32" maxlength="20" />
							</li>
							<li id="validatePassword" style="display: none"
								class="message_error"></li>
							<li><i>Confirm Password:</i><font>*</font> <input
								name="password2" id="password2" type="password" size="32"
								maxlength="20" onBlur="checkpassword2();" />
							</li>
          ...
          <li id="validateUserName" style="display:none" class="message_error"></li>-->
							<li><input name="Conditions" type="checkbox" id="Conditions"
								value="1" onClick="checkConditions();"> <i> <a
										href="https://www.milanoo.com/help/index-id-73.html">I
											agree to the Milanoo Terms & Conditions.</a> </i>
		...
		<div id="allBanner_tmp" class="main_box" style="display: none;">
			<script type='text/javascript'>
		GA_googleAddSlot("ca-pub-3756433676281534", "en-uk_index_top_banner");
		GA_googleFetchAds();
		GA_googleFillSlot("en-uk_index_top_banner");
		jq(function(){genTopAddCountDown("allBanner_tmp",-2017966)});
	</script>
		</div>
